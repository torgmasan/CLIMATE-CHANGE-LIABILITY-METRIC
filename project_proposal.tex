...
\begin{enumerate}
 ...
 \item[4.] CRI is a dataset of the pdf format which provides information on categories such as score, fatalities, losses in millions of dollars based on the effects of climate in each country in 2018.
...
Our final dataset will consist of the required columns from the raw datasets as mentioned above.
It will be programmatically generated  with a script.\newline

Note: \texttt{cri.pdf} is converted from $.pdf \rightarrow .txt \rightarrow .csv$
beforehand manually.
This is required since the final dataset generating script expects $.csv$ input parameters. \newline
